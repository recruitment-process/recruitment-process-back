    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=256, unique=True, validators=[django.core.validators.EmailValidator(), users.validators.custom_validate_email])),
                ...
                ('confirmation_code', models.CharField(default='bbba6a3a-5ea7-4d9c-ae2e-3a090951bf20', editable=False, max_length=40)),
